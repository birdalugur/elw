function [fhat,xhat,fcount,retcode] = csminit_ks(fcn,x0,f0,g0,badg,H0,varargin)
...
% original         dx = dx*dxnorm/norm(dx)    % This keeps scale invariant to the angle correction
...
% original         disp(sprintf('Correct for low angle: %g',a))
      end
   end
...
%               lambda = -lambda*factor^6   % CS original version
